        ...
        <section className="mx-auto max-w-7xl px-4 py-10">
          ...
          <div className="mb-10 rounded-2xl bg-gradient-to-br from-emerald-500 via-emerald-600 to-sky-600 p-8 text-white shadow-xl">
            <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
              <div>
                ...
                <p className="text-emerald-50">Bine ai revenit, {company?.displayName || "Companie"}!</p>
              </div>
          ...
          {loading ? (
                      ...
                      <div className="mb-3 flex items-start justify-between">
                        <div>
                          <p className="mb-1 text-lg font-bold text-gray-900">
                            Cerere #{offer.requestId ? String(offer.requestId).slice(0, 8) : "—"}
                          </p>
                            ...
                            >
                              <div className="mb-3 flex flex-col gap-3 sm:flex-row">
                                <div className="flex-1">
                                  <label className="mb-1 block text-xs font-medium text-gray-700">Preț (lei)</label>
                                  <input
                                    type="number"
                                    value={editPrice}
                                ...
                                <div className="flex-1">
                                  <label className="mb-1 block text-xs font-medium text-gray-700">Mesaj</label>
                                  <textarea
                                    value={editMessage}
            ...
            <div className="rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50/50 py-20 text-center">
              ...
              <p className="mt-4 text-lg font-semibold text-gray-700">Nu există oferte de afișat</p>
