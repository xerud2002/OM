...
export default function RoutePage({
  ...
  const { fromCity, toCity, distanceKm, durationHrs, priceEstimate } =
    routeData;
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://ofertemutare.ro/mutari/${fromCity.slug}/${toCity.slug}`}
        />
        <meta
          property="og:image"
            ...
            <div className="container mx-auto px-4">
              <div className="mx-auto max-w-4xl text-center">
                ...
                <h1 className="mb-6 text-3xl font-bold md:text-5xl">
                  Transport Mobilă <br />
                  <span className="text-emerald-400">{fromCity.name}</span>{" "}
                  <span className="text-slate-400">➔</span>{" "}
                  <span className="text-emerald-400">{toCity.name}</span>
                </h1>
                <p className="text-lg text-emerald-100">
                  Servicii rapide și sigure pe ruta {distanceKm} km. Poți
                  economisi prin grupaj (spațiu partajat în camion).
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="md:col-span-2 space-y-12">
              <section>
                <h2 className="mb-6 text-2xl font-bold text-slate-900">
                  Ce trebuie să știi despre mutarea {fromCity.name} -{" "}
                  {toCity.name}
                </h2>
                <div className="prose text-slate-600 text-lg leading-relaxed">
                  <p className="mb-4">
                    Planifici o relocare din <strong>{fromCity.name}</strong>{" "}
                    către <strong>{toCity.name}</strong>? Această rută de{" "}
                    {distanceKm} km este una frecventată de partenerii noștri,
                    ceea ce înseamnă că poți beneficia des de tarife reduse prin
                    sistemul de grupaj (folosirea spațiului rămas în camioane
                    care se întorc goale).
                  </p>
                  <p>
                    Indiferent dacă muți o garsonieră, un apartament complet sau
                    doar câteva piese de mobilier, firmele verificate de pe
                    OferteMutare.ro îți pot asigura un transport sigur și rapid,
                    direct la noul tău domiciliu din {toCity.county}.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="overflow-hidden rounded-xl border border-slate-200 bg-white">
                  <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-slate-100 text-slate-700">
                      <tr>
                        ...
                        <td className="px-3 py-2 md:px-6 md:py-4 text-emerald-700 font-bold">
                          {priceEstimate.studio}
                        </td>
                      </tr>
                      <tr>
                        <td className="px-3 py-2 md:px-6 md:py-4 font-medium">
                  ...
                  <div className="bg-emerald-50 p-4 text-sm text-emerald-800">
                    * Prețurile sunt estimative și includ transportul pe baza
                    distanței. Serviciile extra (manipulare, lift exterior) se
                    calculează separat.
                  </div>
                </div>
              </section>
                ...
                <div className="space-y-4">
                  <details className="group rounded-lg bg-white p-4 shadow-sm open:ring-1 open:ring-emerald-500">
                    ...
                    <p className="mt-4 text-slate-600">
                      Pentru distanța de {distanceKm} km, transportul efectiv
                      durează aproximativ {durationHrs} ore. Totuși, ia în
                      calcul și timpii de încărcare/descărcare (2-4 ore), deci o
                      mutare completă durează de obicei o zi întreagă.
                    </p>
                  </details>
                  <details className="group rounded-lg bg-white p-4 shadow-sm open:ring-1 open:ring-emerald-500">
                    <summary className="flex cursor-pointer list-none items-center justify-between font-medium text-slate-900">
                    ...
                    <p className="mt-4 text-slate-600">
                      Da, toate firmele partenere Premium includ asigurare CMR
                      pentru transportul rutier de marfă, acoperind daune de
                      până la 20.000 EUR pe durata transportului.
                    </p>
                  </details>
                </div>
              </section>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl bg-white p-6 shadow-xl ring-1 ring-slate-200">
                <h3 className="text-xl font-bold text-slate-900 mb-2">
                  Primește Oferte Reale
                </h3>
                <p className="text-sm text-slate-500 mb-6">
                  Firmele concurează pentru mutarea ta. Economisești timp și
                  bani.
                </p>
                <Link
                  href="/customer/auth"
...
export const getStaticProps: GetStaticProps<RoutePageProps> = async ({
  params,
}) => {
  ...
  return {
    props: {
      routeData,
      formattedDate: new Date().toLocaleDateString("ro-RO", {
        month: "long",
        year: "numeric",
      }),
