        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 py-20">
          ...
          <div className="relative mx-auto max-w-6xl px-4">
            ...
            <p className="mb-8 max-w-2xl text-lg text-orange-100 md:text-xl">
              Prețuri prietenoase pentru buzunarul studentului. Transport rapid pentru 
              cămine, garsoniere și chirie. Flexibilitate maximă!
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/customer/auth"
                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-white px-8 py-4 font-bold text-orange-600 shadow-xl transition-all hover:bg-orange-50 hover:shadow-2xl hover:-translate-y-0.5"
              >
        ...
        <article className="mx-auto max-w-4xl px-4 py-16">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              <p>
                Viața de <strong>student</strong> înseamnă schimbări frecvente: de la cămin la chirie, 
                de la un apartament la altul, sau înapoi acasă în vacanțe. Știm că bugetul este limitat, 
                dar asta nu înseamnă că trebuie să cari totul singur!
              </p>
              <p>
                Pe <strong>OferteMutare.ro</strong>, găsești firme care oferă <strong>prețuri 
                speciale pentru studenți</strong>. Completezi un formular rapid, primești oferte, 
                și alegi cea mai bună variantă pentru buzunarul tău.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="flex gap-4 rounded-lg border border-gray-200 bg-white p-5">
                <div className="rounded-lg bg-orange-100 p-2 h-fit">
          ...
          <section className="mb-12 rounded-2xl bg-gradient-to-r from-amber-50 to-yellow-50 p-8">
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>Grupează-te cu colegi:</strong> Dacă mai mulți studenți se mută în 
                  aceeași perioadă, puteți împărți costul unui transport mai mare.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 shrink-0 text-amber-500 mt-1" />
              ...
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 shrink-0 text-amber-500 mt-1" />
                <span>
                  <strong>Cere cutii gratuite:</strong> Supermarketurile (Kaufland, Lidl) dau 
                  cutii gratis. Nu cumpăra material de ambalat scump!
                </span>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border-2 border-green-200 bg-green-50 p-5">
                <h3 className="font-bold text-green-800 mb-2">✓ Perioade ieftine</h3>
              ...
              <div className="rounded-xl border-2 border-red-200 bg-red-50 p-5">
                <h3 className="font-bold text-red-800 mb-2">✕ Perioade scumpe</h3>
                <ul className="text-sm text-gray-700 space-y-1">
