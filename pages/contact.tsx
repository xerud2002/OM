          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {contactInfo.map((item, i) => (
                ...
                >
                  <div className="absolute -top-8 -right-8 h-24 w-24 rounded-full bg-linear-to-br from-emerald-100/50 to-teal-100/50 blur-2xl transition-all group-hover:scale-150" />
            ...
            <div className="grid items-start gap-12 lg:grid-cols-2 lg:gap-16">
                      ...
                      {sent ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                          ...
                          <button
                            type="submit"
                            disabled={sending}
                            className="group flex w-full items-center justify-center gap-2 rounded-xl bg-linear-to-r from-emerald-600 to-teal-600 px-6 py-4 font-bold text-white shadow-lg shadow-emerald-500/25 transition-all hover:shadow-xl hover:shadow-emerald-500/30 disabled:cursor-not-allowed disabled:opacity-70"
                          >
                            {sending ? (
                              <>
                                <motion.div
              ...
              >
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-3 rounded-xl bg-white/10 p-4 backdrop-blur-sm">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-emerald-100">Datele tale sunt în siguranță</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  <p className="mb-6 text-slate-600">
                    Alătură-te rețelei noastre de firme verificate și primește cereri de la clienți
                    din toată țara.
                  </p>
                  <Link
                    href="/company/auth"
