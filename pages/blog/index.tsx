                    ...
                    <div className="relative h-64 overflow-hidden lg:h-auto">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center text-white">
                          <span className="mb-2 inline-block rounded-full bg-white/20 px-4 py-1 text-sm font-semibold backdrop-blur-sm">
                            ⭐ Articol Recomandat
                          </span>
                          <p className="text-lg font-medium opacity-90">Ghid Complet</p>
                        </div>
                      </div>
                    </div>
          ...
          <section className="container mx-auto px-4 pb-20">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {regularPosts.map((post, idx) => (
                <Link key={idx} href={`/articles/${post.slug}`} className="group block">
