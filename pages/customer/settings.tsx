...
export default function CustomerSettings() {
  ...
  useEffect(() => {
    const unsub = onAuthChange(async (u) => {
      ...
      setIsEmailUser(
        u.providerData?.some((p: any) => p.providerId === "password") || false,
      );
      ...
      if (data?.notificationPreferences) {
        setNotifPrefs({
          ...
          emailOnNewMessage:
            data.notificationPreferences.emailOnNewMessage ?? true,
        });
      }
      setLoading(false);
    });
              ...
              <div className="rounded-xl border border-gray-200 bg-white shadow-sm">
                <div className="flex items-center gap-3 border-b border-gray-100 px-5 py-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Preferințe pentru notificări email
                    </p>
                  </div>
                </div>
                <div className="divide-y divide-gray-100 p-5">
                  <div className="flex items-center justify-between py-3">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Primește email când primești o ofertă nouă
                      </p>
                    </div>
                    <ToggleSwitch
                  ...
                  <div className="flex items-center justify-between py-3">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Primește email când o firmă îți trimite un mesaj
                      </p>
                    </div>
                    <ToggleSwitch
                  ...
                  {isEmailUser ? (
                    ...
                    <div className="rounded-lg border border-gray-100 bg-gray-50 p-4">
                      <p className="text-sm text-gray-600">
                        Contul tău folosește autentificarea Google. Parola se
                        gestionează din contul Google.
                      </p>
                    </div>
                  )}
                </div>
