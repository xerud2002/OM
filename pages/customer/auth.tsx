        ...
        <div className="mx-auto grid max-w-6xl gap-8 overflow-hidden rounded-3xl bg-white shadow-2xl lg:grid-cols-2">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-emerald-50">
                Primești până la 5 oferte de la firme verificate și alegi cea mai bună pentru tine.
              </p>
            </div>
          ...
          >
            ...
            <div className="mt-4 text-center text-sm text-gray-500">
              ...
              <a href="/company/auth" className="font-medium text-blue-600 hover:underline">
                Click aici
              </a>
            </div>
          </motion.div>
