  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:url" content="https://ofertemutare.ro/servicii/debarasare" />
        <meta name="twitter:title" content={`Debarasare ${currentYear}`} />
        <meta name="twitter:description" content="Evacuare mobilă și gunoi. Transport și reciclare!" />
