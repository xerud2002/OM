...
export interface CityData {
  ...
  population: string;
  tier: 1 | 2;
  region?: 'transilvania' | 'moldova' | 'muntenia' | 'banat' | 'oltenia'; // Historical region
  landmarks: string[];
  neighborhoods: string[];
  metaDescription: string;
  heroSubtitle: string;
  heroImage?: string; // Optional: Path to landmark image for hero background
  // Unique SEO content
  articleIntro?: string;
  whyChooseUs?: string[];
  localTips?: string[];
...
export const cityData: CityData[] = [
  ...
  },
  {
    ...
    whyChooseUs: [
      ...
      "Rute către Moldova: Conexiuni regulate către Brăila, Tecuci, Bârlad pentru mutări intercounty la prețuri reduse.",
    ],
    localTips: [
