...
const cities: Record<string, string[]> = {
  ...
  Bihor: ["Oradea", "Aleșd", "Beiuș", "Marghita", "Nucet", "Salonta", "Ștei", "Vașcău"],
  ...
  Dâmbovița: ["Târgoviște", "Fieni", "Găești", "Moreni", "Pucioasa", "Răcari", "Titu"],
  Dolj: ["Craiova", "Bechet", "Calafat", "Băilești", "Dăbuleni", "Filiași", "Segarcea"],
  ...
  Olt: ["Slatina", "Balș", "Corabia", "Drăgănești-Olt", "Piatra-Olt", "Potcoava", "Scornicești"],
  Prahova: [
    "Ploiești",
    "Azuga",
    "Băicoi",
