    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl sm:rounded-2xl border border-gray-100 bg-white p-3 sm:p-5 shadow-sm">
        <div className="mb-3 sm:mb-4 flex items-center gap-2">
          <div className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-lg bg-emerald-100">
            <MapPinIcon className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-600" />
          </div>
        ...
        <div className="grid gap-4 sm:gap-6 sm:grid-cols-[1fr_auto_1fr]">
          {/* DE LA */}
          <div className="relative">
            <div className="absolute -left-3 top-2 bottom-0 w-0.5 bg-gray-100 sm:hidden"></div>

            <div className="mb-1 flex items-center gap-1.5">
              <span className="flex h-5 w-5 sm:h-6 sm:w-6 items-center justify-center rounded-full bg-blue-100 text-[9px] sm:text-[10px] font-bold text-blue-700 ring-2 ring-white">
                A
              </span>
              <p className="text-[10px] sm:text-xs font-bold tracking-wide text-gray-400 uppercase">
                Punct de plecare
              </p>
            </div>
          ...
          <div className="relative hidden sm:flex items-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center absolute bg-white p-1.5 rounded-full border border-gray-100 shadow-sm z-10">
          ...
          <div className="relative">
            ...
            <div className="mb-1 flex items-center gap-1.5">
              <span className="flex h-5 w-5 sm:h-6 sm:w-6 items-center justify-center rounded-full bg-emerald-100 text-[9px] sm:text-[10px] font-bold text-emerald-700 ring-2 ring-white">
                B
              </span>
              <p className="text-[10px] sm:text-xs font-bold tracking-wide text-gray-400 uppercase">
                Destinație
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        {/* Contact */}
        {request.contactName && (
          <div className="col-span-2 flex items-start gap-3 rounded-xl border border-gray-100 bg-white p-3 shadow-sm">
            <div className="flex h-8 w-8 sm:h-9 sm:w-9 shrink-0 items-center justify-center rounded-lg bg-indigo-50">
              <UserIcon className="h-4 w-4 sm:h-5 sm:w-5 text-indigo-600" />
            </div>
            <div className="min-w-0">
              <h4 className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-gray-400">
                Persoană Contact
      ...
      {(request.serviceMoving ||
        ...
        request.serviceAssembly ||
        request.serviceDisposal ||
        request.servicePackingMaterials) && (
        <div className="rounded-xl sm:rounded-2xl border border-gray-100 bg-white p-3 sm:p-5 shadow-sm">
          <div className="mb-3 flex items-center gap-2">
            <div className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-lg bg-orange-50">
              <WrenchScrewdriverIcon className="h-4 w-4 sm:h-5 sm:w-5 text-orange-600" />
            </div>
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">
              Tip Serviciu
            </h3>
            ...
            {(
              ...
              .map((s) => {
                ...
                return (
                  <span
                    key={s.key}
                    className={`inline-flex items-center gap-1 rounded-md border px-2 py-1 sm:px-2.5 sm:py-1.5 text-xs sm:text-sm font-medium ${colors[s.color]}`}
                  >
      ...
      {request.details && (
        <div className="rounded-xl sm:rounded-2xl border border-gray-100 bg-white p-3 sm:p-5 shadow-sm">
          <div className="mb-2 flex items-center gap-2">
            <div className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-lg bg-gray-100">
      ...
      {localMediaUrls && localMediaUrls.length > 0 && (
        <div className="rounded-xl sm:rounded-2xl border border-gray-100 bg-white p-3 sm:p-5 shadow-sm">
          <div className="mb-3 flex items-center gap-2">
            <div className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-lg bg-amber-50">
              <PhotoIcon className="h-4 w-4 sm:h-5 sm:w-5 text-amber-600" />
            </div>
            <h3 className="text-sm sm:text-base font-semibold text-gray-900">
              Poze & Video ({localMediaUrls.length})
            </h3>
          </div>
