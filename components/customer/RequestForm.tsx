          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div>
              ...
              {((form as any).moveDateMode ?? "exact") === "exact" && (
                <div className="flex justify-center rounded-2xl border-2 border-emerald-300 bg-linear-to-br from-white via-emerald-50/30 to-emerald-100/30 p-5 shadow-md">
                  <DayPicker
                    mode="single"
