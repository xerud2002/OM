        ...
        <div>
          ...
          {!form.fromCityManual ? (
            ...
            >
              ...
              {getCityOptions(form.fromCounty).map(c => <option key={c} value={c}>{c}</option>)}
        ...
        <div>
          ...
          {!form.toCityManual ? (
            ...
            >
              ...
              {getCityOptions(form.toCounty).map(c => <option key={c} value={c}>{c}</option>)}
              <option value="__other__">Altă localitate...</option>
            </select>
          ) : (
             <div className="flex gap-2">
            ...
            return (
              <div
                ...
                className={`relative overflow-hidden rounded-2xl border bg-white shadow-sm transition-all duration-500 ${
                    isCurrent ? 'border-emerald-500 ring-4 ring-emerald-500/10' : 
