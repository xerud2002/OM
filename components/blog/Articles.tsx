  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-slate-50 to-white py-12 sm:py-20 lg:py-32">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute right-0 top-1/4 h-75 w-75 translate-x-1/2 rounded-full bg-emerald-100/30 blur-[80px] sm:h-125 sm:w-125 sm:blur-[100px]" />
        <div className="absolute bottom-0 left-0 hidden h-100 w-100 -translate-x-1/2 rounded-full bg-sky-100/30 blur-[100px] sm:block" />
      </div>
