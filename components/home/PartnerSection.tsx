    ...
    <section className="py-20 bg-gradient-to-br from-emerald-50 via-white to-sky-50 relative overflow-hidden">
      <FadeInWhenVisible>
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center rounded-3xl shadow-xl bg-white/85 backdrop-blur-md p-10 border border-emerald-100 relative z-10"
        >
          <SlideInWhenVisible direction="left" className="space-y-5">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Prin platforma <strong>ofertemutare.ro</strong> primești cereri reale de la clienți interesați, 
              din orașul tău și din toată țara.
            </p>
