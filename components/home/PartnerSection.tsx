  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-white to-slate-50 py-12 sm:py-20 lg:py-32">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute bottom-0 left-0 h-75 w-75 -translate-x-1/2 translate-y-1/4 rounded-full bg-emerald-100/40 blur-[80px] sm:h-125 sm:w-125 sm:blur-[100px]" />
        <div className="absolute top-0 right-0 hidden h-100 w-100 translate-x-1/4 -translate-y-1/4 rounded-full bg-sky-100/40 blur-[100px] sm:block" />
      </div>
